<thead class="sticky-header">
    <tr class="svcr-list-header">
        @foreach(['courseNames' => 'Course Name', 'departmentName' => 'Area', 'instructorName'=>'Instructor' ,'enrolledStudents' => 'Enrolled', 'droppedStudents' => 'Dropped', 'courseCapacity' => 'Capacity', 'seiData' => 'SEI Data'] as $field => $label)

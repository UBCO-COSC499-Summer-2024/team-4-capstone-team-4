<thead class="sticky-header">
    <tr class="svcr-list-header">
        @foreach(['courseNames' => 'Course Name', 'departmentName' => 'Area', 'enrolledStudents' => 'Enrolled', 'droppedStudents' => 'Dropped', 'courseCapacity' => 'Course Capacity', 'seiData' => 'SEI Data'] as $field => $label)

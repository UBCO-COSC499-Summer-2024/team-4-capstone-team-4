    ...
    <form wire:submit.prevent="handleClick" class="import-form relative">
        ...
        <div class="import-form-row flex justify-between items-center p-2 border-b">
            ...
            <div class="import-input w-4/12">
                <input type="text" placeholder="123456" wire:model="rows.{{$index}}.id" class="p-1 w-full">
            </div>
            <div class="import-input w-3/12">
                <input type="text" placeholder="#" wire:model="rows.{{$index}}.firstname" class="p-1 w-full">
            </div>
            <div class="import-input w-3/12">
                <input type="text" placeholder="#" wire:model="rows.{{$index}}.lastname" class="p-1 w-full">
            </div>
            <div class="import-input w-3/12">
                <input type="text" placeholder="#" wire:model="rows.{{$index}}.lastname" class="p-1 w-full">
            </div>

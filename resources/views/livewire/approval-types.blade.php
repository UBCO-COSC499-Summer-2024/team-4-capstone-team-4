            ...
            <div class="filter">
                ...
                <div class="filter-items-holder glass">
                    ...
                    @foreach ($filters as $category => $filter)
                        <div class="filter-category" wire:key="filter_type_{{ $category }}">
                            ...
                            <div class="filter-items">
                                @foreach ($filter as $item)
                                    <div class="filter-item nos"
                                        wire:key="filter_type_{{ $category }}_{{ $item }}"
                                        x-data="{
                                            category: '{{ $category }}',
                                            item: '{{ $item }}',
                ...
                <tr class="svcr-list-header">
                    ...
                    @foreach ($headers as $index => $header)
                        @php
                            ...
                            $label = $header['label'];
                        @endphp
                        <th class="svcr-list-header-item" data-column="{{ $column }}" wire:key="approval_type_header_{{ $column }}">

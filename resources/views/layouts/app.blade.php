...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        'resources/css/calendar.css', 'resources/css/card.css', 'resources/css/dropdown.css', 'resources/css/import.css', 'resources/css/svcr.css', 'resources/css/filter.css', 'resources/css/requests.css', 'resources/js/app.js', 'resources/js/events.js', 'resources/js/sidebar.js', 'resources/js/tabs.js',
         'resources/js/dropdown.js', 'resources/js/staff.js', 'resources/js/sortTable.js', 'resources/js/buttons.js','resources/js/coursedetails-search.js', 'resources/js/exportReport.js','resources/js/coursedetails-modal.js', 'resources/js/darkmode.js', 'resources/css/reports.css', 'resources/js/filters.js'])
